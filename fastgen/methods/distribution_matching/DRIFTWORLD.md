...
candidates act as mutually repulsive samples, the data video is the positive
sample, and the preceding real frame is the feature-space static-transition
negative. This preserves the original latent-spatial signal while adding
...
on five adjacent RGB frames at indices 30/31/32/33/34 at 640x384, skipping
