...
|---------------|-------|--------|-------|--------|----------|--------------|----------------|--------|
| HYP-20260817-17 | Wan2.2 framewise DriftWorld, five adjacent frames | implementation_validated | exploratory | feature/wan22-driftworld-f5-s1-n64 | isolated | pending | 64-candidate FSDP smoke completed | [link](./HYP-20260817-17.md) |
