...
|---------------|-------|--------|-------|--------|----------|--------------|----------------|--------|
| HYP-20260818-24 | DriftWorld EMA stabilization | implementation | exploratory | feature/wan22-driftworld-f5-s1-n64 | isolated | pending | Enable constant EMA decay 0.999; validation pending | [link](./HYP-20260818-24.md) |
