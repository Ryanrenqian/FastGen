...
|---------------|-------|--------|-------|--------|----------|--------------|----------------|--------|
| HYP-20260818-24 | DriftWorld EMA stabilization | implementation_validated | exploratory | feature/wan22-driftworld-f5-s1-n64 | isolated | pending | Constant EMA decay 0.999; 13 development-machine tests passed | [link](./HYP-20260818-24.md) |
